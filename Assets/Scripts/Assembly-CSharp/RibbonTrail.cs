...
public class RibbonTrail
{
	...
	public void Smooth()
	{
		if (ElemCount > 3)
		{
			...
			if (num3 > 60f)
			{
				Vector3 vector2 = (element.Position + element3.Position) / 2f;
				Vector3 vector3 = vector2 - element2.Position;
				Vector3 currentVelocity = Vector3.zero;
				float smoothTime = 0.1f / (num3 / 60f);
				element2.Position = Vector3.SmoothDamp(element2.Position, element2.Position + vector3.normalized * element2.Width, ref currentVelocity, smoothTime);
			}
		}
	}
