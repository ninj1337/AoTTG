...
public class CostumeConeveter
{
	public static HeroCostume PhotonDataToHeroCostume(PhotonPlayer player)
	{
		...
		heroCostume.hairInfo = ((heroCostume.sex != SEX.MALE) ? CostumeHair.hairsF[(int)player.customProperties[PhotonPlayerProperty.hairInfo]] : CostumeHair.hairsM[(int)player.customProperties[PhotonPlayerProperty.hairInfo]]);
